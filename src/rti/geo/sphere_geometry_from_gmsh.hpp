...
namespace rti { namespace geo {
  ...
  class sphere_geometry_from_gmsh : public rti::geo::absc_geometry_from_gmsh<float> {
  public:
    sphere_geometry_from_gmsh(RTCDevice& pDevice, rti::io::gmsh_reader& pGmshReader) :
      absc_geometry_from_gmsh(pDevice, pGmshReader) {
      init_this(pDevice, pGmshReader);
    }

    void print(std::ostream& pOs) const override final {
      pOs << "(:class sphere_geometry_from_gmsh";
