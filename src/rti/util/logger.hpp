...
#define RLOG_INFO rti::util::sLStream << "[info] "
#else
...
#ifdef RLOG_LEVEL_PROGRESS
#define RLOG_PROGRESS rti::util::sLStream
#else
#define RLOG_PROGRESS if (true) {} else rti::util::sLStream
#endif
