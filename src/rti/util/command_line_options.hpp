...
namespace rti { namespace util {
  ...
  public:
    ...
    std::string get_option_value(rti::util::command_line_options::option_type pType) {
      for (auto & oo : options) {
  ...
  private:
    ...
    std::unordered_map<option_type, option_spec, rti::util::enum_class_hash_function> options {
