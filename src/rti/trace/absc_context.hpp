...
// (2) Call init() on each rti::trace::absc_context<Ty> intstance at least once to initialize
...
namespace rti { namespace trace {
  ...
  public:
    ...
    absc_context(float pRayWeight, bool pReflect, rti::util::pair<rti::util::triple<Ty> >& pRayout, Ty pTfar) :
