...
namespace rti {
  ...
  class rectangle_origin_z : public i_origin<Ty> {
  public:

    rectangle_origin_z(Ty pZval, rti::pair<Ty> pC1, rti::pair<Ty> pC2) :
      mZval(pZval),
      mC1(pC1),
      mC2(pC2) {
    ...
    rti::triple<Ty> get(rti::i_rng& pRng, rti::i_rng::i_state& pRngState) const override final {
